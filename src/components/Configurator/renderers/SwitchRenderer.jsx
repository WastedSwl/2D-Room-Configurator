...
import { ReactComponent as SwitchX1Svg } from '../../Assets/switchx1.svg';
...
const SwitchRenderer = ({
  ...
  const switchDefaults = defaultObjectSizes[OBJECT_TYPES.SWITCH];
  ...
  const svgStyle = {
    fill: isSelected ? "rgba(251, 253, 255, 0.2)" : "rgba(240, 240, 245, 0.95)", // Светлее
...
export default React.memo(SwitchRenderer);